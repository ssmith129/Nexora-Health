        ...
        <div className="modal-body">
          ...
          <div className="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-4">
            ...
            <div className="text-lg-end">
              ...
              <p className="mb-1">
                <span className="text-dark fw-medium">Collected On: </span>25
                Jan 2024, 10:00 AM
              </p>
              <p className="mb-0">
                <span className="text-dark fw-medium">Reported On: </span>25 Jan
                2024, 11:00 AM
              </p>
            </div>
          </div>
          ...
          <div className="table-responsive table-nowrap mb-4">
            <table className="table mb-0 rounded border">
              ...
              <tbody>
                ...
                <tr>
                  <td colSpan={4}>
                    <h6 className="mb-0 fs-14 fw-semibold">Platelet Count</h6>
                  </td>
                </tr>
                <tr>
          ...
          <div className="d-flex justify-content-between align-items-center gap-3 flex-wrap">
            <div>
              <ImageWithBasePath src="assets/img/icons/qr-code.svg" alt="qr-code" />
            </div>
