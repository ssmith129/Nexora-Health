...
const ManageAddInvoices = () => {
  // State for invoice items
  const [items, setItems] = useState([
    { name: "Surgical Gloves", quantity: 10, unitPrice: 45, discount: 10, amount: 40.5 },
    { name: "Medical Syringes", quantity: 5, unitPrice: 65, discount: 5, amount: 55.5},
  ]);
      ...
      <div className="page-wrapper">
        ...
        <div className="content">
          ...
          <div className="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
            <h6 className="mb-0">
              <Link to={all_routes.manageInvoices}>
...
export default ManageAddInvoices;
