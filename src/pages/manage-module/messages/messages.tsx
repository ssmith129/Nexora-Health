              ...
              <div className="d-md-flex">
                  ...
                  <div>
                    <div className="d-flex align-items-center justify-content-between border-bottom p-3">
                      <div className="d-flex align-items-center">
                        <span className="avatar me-2 flex-shrink-0">
                          <ImageWithBasePath
                            src="assets/img/avatars/avatar-57.jpg"
                            alt="user"
                          />
                        </span>
                        <div>
                    ...
                    <div>
                      ...
                      <OverlayScrollbarsComponent
                        style={{ maxHeight: "calc(100vh - 18rem)" }} className="chat-users p-4" data-simplebar="">
                        ...
                        <div className="d-flex align-items-center justify-content-between rounded p-3 user-list active mb-1">
                          <div className="d-flex align-items-center">
                            <Link to="#" className="avatar me-2 flex-shrink-0">
                              <ImageWithBasePath
                                src="assets/img/avatars/avatar-58.jpg"
                                alt="user"
                              />
                            </Link>
                            <div>
                        ...
                        <div className="d-flex align-items-center justify-content-between rounded p-3 user-list mb-1">
                          <div className="d-flex align-items-center">
                            <Link to="#" className="avatar me-2 flex-shrink-0">
                              <ImageWithBasePath
                                src="assets/img/avatars/avatar-59.jpg"
                                alt="user"
                              />
                            </Link>
                            <div>
                        ...
                        <div className="d-flex align-items-center justify-content-between rounded p-3 user-list mb-1">
                          <div className="d-flex align-items-center">
                            <Link to="#" className="avatar me-2 flex-shrink-0">
                              <ImageWithBasePath
                                src="assets/img/avatars/avatar-60.jpg"
                                alt="user"
                              />
                            </Link>
                            <div>
                        ...
                        <div className="d-flex align-items-center justify-content-between rounded p-3 user-list mb-1">
                          <div className="d-flex align-items-center">
                            <Link to="#" className="avatar me-2 flex-shrink-0">
                              <ImageWithBasePath
                                src="assets/img/avatars/avatar-61.jpg"
                                alt="user"
                              />
                            </Link>
                            <div>
                        ...
                        <div className="d-flex align-items-center justify-content-between rounded p-3 user-list mb-1">
                          <div className="d-flex align-items-center">
                            <Link to="#" className="avatar me-2 flex-shrink-0">
                              <ImageWithBasePath
                                src="assets/img/avatars/avatar-62.jpg"
                                alt="user"
                              />
                            </Link>
                            <div>
                        ...
                        <div className="d-flex align-items-center justify-content-between rounded p-3 user-list mb-1">
                          <div className="d-flex align-items-center">
                            <Link to="#" className="avatar me-2 flex-shrink-0">
                              <ImageWithBasePath
                                src="assets/img/avatars/avatar-63.jpg"
                                alt="user"
                              />
                            </Link>
                            <div>
                        ...
                        <div className="d-flex align-items-center justify-content-between rounded p-3 user-list mb-1">
                          <div className="d-flex align-items-center">
                            <Link to="#" className="avatar me-2 flex-shrink-0">
                              <ImageWithBasePath
                                src="assets/img/avatars/avatar-64.jpg"
                                alt="user"
                              />
                            </Link>
                            <div>
                        ...
                        <div className="d-flex align-items-center justify-content-between rounded p-3 user-list">
                          <div className="d-flex align-items-center">
                            <Link to="#" className="avatar me-2 flex-shrink-0">
                              <ImageWithBasePath
                                src="assets/img/avatars/avatar-65.jpg"
                                alt="user"
                              />
                            </Link>
                            <div>
                ...
                <div className="flex-fill chat-messages">
                  ...
                  <div className="card border-0 mb-0">
                    ...
                    <div className="card-body p-0">
                      <OverlayScrollbarsComponent
                        style={{ maxHeight: "calc(100vh - 18.5rem)" }} className="message-body p-4" data-simplebar="">
                          ...
                          <div className="d-flex align-items-start">
                            ...
                            <div>
                              ...
                              <div className="d-flex align-items-center">
                                ...
                                <div className="ms-2">
                                  <Link to="#" data-bs-toggle="dropdown" aria-label="Lab result actions menu" aria-haspopup="true" aria-expanded="false">
