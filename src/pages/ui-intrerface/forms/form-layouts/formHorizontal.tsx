    ...
    <>
      ...
      <div className="page-wrapper">
        ...
        <div className="content">
          {/* Page Header */}
          <AutoBreadcrumb title="Form Horizontal" />
                ...
                <div className="card-body">
                  <form action="#">
                    <div className="row mb-3">
                      <label className="col-lg-3 form-label" htmlFor="horizontal-first-name">First Name</label>
                      <div className="col-lg-9">
                        <input type="text" className="form-control" id="horizontal-first-name" />
                      </div>
                    </div>
                    <div className="row mb-3">
                      <label className="col-lg-3 form-label" htmlFor="horizontal-last-name">Last Name</label>
                      <div className="col-lg-9">
                        <input type="text" className="form-control" id="horizontal-last-name" />
                      </div>
                    </div>
                    <div className="row mb-3">
                      <label className="col-lg-3 form-label" htmlFor="horizontal-email">Email Address</label>
                      <div className="col-lg-9">
                        <input type="email" className="form-control" id="horizontal-email" />
                      </div>
                    </div>
                    <div className="row mb-3">
                      <label className="col-lg-3 form-label" htmlFor="horizontal-username">Username</label>
                      <div className="col-lg-9">
                        <input type="text" className="form-control" id="horizontal-username" />
                      </div>
                    </div>
                    <div className="row mb-3">
                      <label className="col-lg-3 form-label" htmlFor="horizontal-password">Password</label>
                      <div className="col-lg-9">
                        <input type="password" className="form-control" id="horizontal-password" />
                      </div>
                    </div>
                    <div className="row mb-3">
              ...
              <div className="card ">
                ...
                <div className="card-body">
                  <form action="#">
                    ...
                    <div className="row mb-3">
                      <label className="col-lg-3 form-label" htmlFor="horizontal-state">State</label>
                      <div className="col-lg-9">
                        <input type="text" className="form-control" />
                      </div>
                    </div>
                    ...
                    <div className="row">
                      <div className="col-xl-6">
                        ...
                        <div className="row mb-3">
                          <label className="col-lg-3 form-label" htmlFor="horizontal-state">State</label>
                          <div className="col-lg-9">
                            <select className="form-select" id="horizontal-state">
                        ...
                        <div className="row mb-3">
                          <label className="col-lg-3 form-label" htmlFor="horizontal-about">About</label>
                          <div className="col-lg-9">
                            <textarea rows={4} cols={5} className="form-control" id="horizontal-about" placeholder="Enter message" defaultValue={""} />
                          </div>
                        </div>
                      </div>
                      <div className="col-xl-6">
