    ...
    <>
      ...
      <div className="page-wrapper">
        ...
        <div className="content">
          {/* Page Header */}
          <AutoBreadcrumb title="Form Validation" />
                  ...
                  <form className="needs-validation" noValidate>
                    <div className="form-row row">
                      <div className="col-md-4 mb-3">
                        <label
                          className="form-label"
                          htmlFor="validation-tooltip-first-name"
                        >
                          First name
                        </label>
                        <input
                          type="text"
                          className="form-control"
                          id="validation-tooltip-first-name"
                          placeholder="First name"
                          defaultValue="Mark"
                          required
                        />
                      ...
                      <div className="col-md-4 mb-3">
                        <label
                          className="form-label"
                          htmlFor="validation-tooltip-last-name"
                        >
                          Last name
                        </label>
                        <input
                          type="text"
                          className="form-control"
                          id="validation-tooltip-last-name"
                          placeholder="Last name"
                          defaultValue="Otto"
                          required
                        />
