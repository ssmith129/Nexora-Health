      ...
      <div className="content pb-0">
        ...
        <div className="row">
          <div className="col-12">
            <h4 className="mb-3">Card Colored</h4>
          </div>{" "}
          {/* end col */}
        </div>
        {/* end row */}
        ...
        <div className="row">
          <div className="col-lg-4 col-sm-6">
            <div className="card text-bg-secondary card-colored">
              <div className="card-body">
        ...
        <div className="row">
          <div className="col-12">
            <h4 className="mb-3">Card Bordered</h4>
          </div>{" "}
          {/* end col */}
        </div>
        {/* end row */}
        ...
        <div className="row">
          <div className="col-12">
            <h4 className="mb-3">Horizontal Card</h4>
          </div>{" "}
          {/* end col */}
        </div>
        {/* end row */}
        ...
        <div className="row">
          <div className="col-12">
            <h4 className="mb-3">Stretched link</h4>
          </div>{" "}
          {/* end col */}
        </div>
        {/* end row */}
        ...
        <div className="row">
          <div className="col-12">
            <h4 className="mb-3">Card Group</h4>
          </div>{" "}
          {/* end col */}
        </div>
        {/* end row */}
