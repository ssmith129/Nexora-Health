...
function useScrollspy(ids: string[], offset = 0, scrollContainer?: string) {
  ...
  useEffect(() => {
    ...
    (container as HTMLElement | Window).addEventListener(
      "scroll",
      handleScroll,
      { passive: true }
    );
    handleScroll();
    return () =>
      (container as HTMLElement | Window).removeEventListener(
        "scroll",
        handleScroll
      );
...
const LIST_IDS = ["list-item-1", "list-item-2", "list-item-3", "list-item-4"];
    ...
    <>
      ...
      <div className="page-wrapper">
        ...
        <div className="content pb-0">
          {/* Page Header */}
         <AutoBreadcrumb title="Scrollspy"/>
                ...
                <ul className="nav nav-pills">
                  ...
                  <li className="nav-item dropdown">
                    <Link
                     ...
                     aria-label="Lab result actions menu"  aria-expanded="false">
                      Dropdown
                    </Link>
                    <div className="dropdown-menu dropdown-menu-end">
                      <Link
                        className={`dropdown-item${
                          activeNavbar === "one" ? " active" : ""
                        }`}
                        to="#one"
                      >
                        one
