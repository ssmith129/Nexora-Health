    ...
    <>
      ...
      <div className="page-wrapper">
        ...
        <div className="content pb-0">
          {/* Page Header */}
          <AutoBreadcrumb title="Accordion" />
          {/* End Page Header */}
          {/* start row */}
          <div className="row">
            <div className="col-xl-6">
              <div className="card">
                ...
                <div className="card-body">
                  <div className="accordion default-accordion" id="accordionExample" role="region" aria-label="Accordion content">
              ...
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <div
                    ...
                    role="region"
                    aria-label="Accordion with panels that stay open"
                  >
                    <div className="accordion-item">
                      <h2
                        className="accordion-header"
