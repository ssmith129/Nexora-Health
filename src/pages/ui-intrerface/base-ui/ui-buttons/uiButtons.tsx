      ...
      <div className="row">
          ...
          <div className="card">
            ...
            <div className="card-body">
              <p className="text-xl mb-3">
                ...
                class with the below-mentioned variation to create a button with
                the outline.
              </p>
              <div className="d-flex align-items-center flex-wrap gap-2">
          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <div className="btn-list">
                <button
                  type="button"
                  className="btn  bg-primary-gradient btn-primary btn-effect me-2"
                >
                  Primary
                </button>
                <button
                  type="button"
                  className="btn  bg-secondary-gradient btn-secondary me-2"
                >
                  Secondary
                </button>
                <button
                  type="button"
                  className="btn  bg-success-gradient btn-success me-2"
                >
                  Success
                </button>
                <button
                  type="button"
                  className="btn  bg-danger-gradient btn-danger me-2"
                >
                  Danger
                </button>
                <button
                  type="button"
                  className="btn  bg-warning-gradient btn-warning me-2"
                >
                  Warning
                </button>
                <button
                  type="button"
                  className="btn  bg-info-gradient btn-info me-2"
                >
                  Info
                </button>
                <button
                  type="button"
                  className="btn  bg-light-gradient btn-light me-2"
                >
                  Light
                </button>
                <button
          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <div className="btn-list">
                <button
                  type="button"
                  className="btn btn-primary btn-animation  me-2"
                  data-text="Primary"
                >
                  <span>Primary</span>
                </button>
                <button
                  type="button"
                  className="btn btn-secondary btn-animation me-2"
                  data-text="Secondary"
                >
                  <span>Secondary</span>
                </button>
                <button
                  type="button"
                  className="btn btn-success btn-animation me-2"
                  data-text="Success"
                >
                  <span>Success</span>
                </button>
                <button
                  type="button"
                  className="btn btn-danger btn-animation me-2"
                  data-text="Danger"
                >
                  <span>Danger</span>
                </button>
                <button
                  type="button"
                  className="btn btn-warning btn-animation me-2"
                  data-text="Warning"
                >
                  <span>Warning</span>
                </button>
                <button
                  type="button"
                  className="btn btn-info btn-animation me-2"
                  data-text="Info"
                >
                  <span>Info</span>
                </button>
        ...
        <div className="col-xl-12">
          <div className="card">
            ...
            <div className="card-body">
              <p className="text-xl mb-3">
                Use the <span className="text-secondary">btn-label</span> class
                to create a button with the label.
              </p>
        ...
        <div className="col-xl-12">
          <div className="card">
            ...
            <div className="card-body">
              <p className="text-xl mb-3">
                Use the{" "}
                <span className="text-secondary">data-bs-toggle="button"</span>{" "}
        ...
        <div className="col-xl-12">
          <div className="card">
            ...
            <div className="card-body">
              <p className="text-xl mb-3">
                Use <span className="text-secondary">btn-icon</span> class to
                wrap icon in button
              </p>
