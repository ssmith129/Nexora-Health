...
const UiDropdowns = () => {
  ...
  <div className="page-wrapper">
    ...
    <div className="content pb-0">
      {/* Page Header */}
        <AutoBreadcrumb title="Dropdowns" />
      {/* End Page Header */}
      {/* start row */}
      <div className="row">
          ...
          <div className="card">
            ...
            <div className="card-body">
              <p className="text-muted">
                ...
                toggle with some markup changes. Here’s how you can put them to
                work with either <code>&lt;button&gt;</code> elements:
              </p>
              <div className="row">
        ...
        <div className="col-xl-6">
          <div className="card">
            ...
            <div className="card-body">
              ...
              <div className="btn-group dropstart me-1">
                <button
                  type="button"
                  className="btn btn-secondary dropdown-toggle"
                  data-bs-toggle="dropdown"
          ...
          <div className="card">
            ...
            <div className="card-body">
              <p className="text-muted">
                ...
                spacing utilities. Note that you’ll likely need additional
