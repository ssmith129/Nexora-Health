...
const UiUtilities = () => {
  ...
  <div className="page-wrapper">
    ...
    <div className="content pb-0">
      {/* Page Header */}
     <AutoBreadcrumb title="Utilities"/>
      {/* End Page Header */}
      {/* start row */}
      <div className="row">
          ...
          <div className="card">
            ...
            <div className="card-body pb-1">
              <p className="text-muted">
                ...
                have <code>:hover</code> and <code>:focus</code> states.
              </p>
              {/* start row */}
              <div className="row">
          ...
          <div className="card card-h-100">
            ...
            <div className="card-body">
              <p className="text-muted">
                ...
                element. The opacity level describes the transparency level,
                where <code>1</code> is not transparent at all, <code>.5</code>{" "}
                is 50% visible, and <code>0</code> is completely transparent.
        ...
        <div className="col-xl-6">
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p>
                <a href="#" className="pe-none" tabIndex={-1}>
                  This link
                </a>{" "}
                can not be clicked.
              </p>
            ...
            <div className="card-body">
              ...
              <div className="d-flex flex-wrap gap-3">
                ...
                <div
                  ...
                  style={{ maxWidth: 260, maxHeight: 100 }}
                >
                  This is an example of using <code>.overflow-visible</code> on
                  an elementwith set width and height dimensions.
                </div>
                <div
