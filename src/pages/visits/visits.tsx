                  ...
                  <tr>
                    ...
                    <td>
                      <div className="d-flex align-items-center">
                        ...
                        <div>
                          <h6 className="fs-14 mb-0 fw-medium">
                            <Link to={all_routes.doctorDetails}>Dr. Christopher Lewis</Link>
                          </h6>
                        </div>
                      </div>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="d-flex align-items-center">
                        ...
                        <div>
                          <h6 className="fs-14 mb-0 fw-medium">
                            <Link to={all_routes.patientDetails}>Sophia Wilson</Link>
                          </h6>
                        </div>
                      </div>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="d-flex align-items-center">
                        ...
                        <div>
                          <h6 className="fs-14 mb-0 fw-medium">
                            <Link to={all_routes.patientDetails}>Daniel Williams</Link>
                          </h6>
                        </div>
                      </div>
                    </td>
                    ...
                    <td>
                      <div className="d-flex align-items-center">
                        ...
                        <div>
                          <h6 className="fs-14 mb-0 fw-medium">
                            <Link to={all_routes.doctorDetails}>Dr. Jonathan Adams</Link>
                          </h6>
                        </div>
                      </div>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="d-flex align-items-center">
                        ...
                        <div>
                          <h6 className="fs-14 mb-0 fw-medium">
                            <Link to={all_routes.patientDetails}>Isabella Anderson</Link>
                          </h6>
                        </div>
                      </div>
                    </td>
                    ...
                    <td>
                      <div className="d-flex align-items-center">
                        ...
                        <div>
                          <h6 className="fs-14 mb-0 fw-medium">
                            <Link to={all_routes.doctorDetails}>Dr. Rebecca Scott</Link>
                          </h6>
                        </div>
                      </div>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="d-flex align-items-center">
                        ...
                        <div>
                          <h6 className="fs-14 mb-0 fw-medium">
                            <Link to={all_routes.patientDetails}>William Brown</Link>
                          </h6>
                        </div>
                      </div>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="d-flex align-items-center">
                        ...
                        <div>
                          <h6 className="fs-14 mb-0 fw-medium">
                            <Link to={all_routes.patientDetails}>Charlotte Taylor</Link>
                          </h6>
                        </div>
                      </div>
                    </td>
                    ...
                    <td>
                      <div className="d-flex align-items-center">
                        ...
                        <div>
                          <h6 className="fs-14 mb-0 fw-medium">
                            <Link to={all_routes.doctorDetails}>Dr. Victoria Evans</Link>
                          </h6>
                        </div>
                      </div>
                    </td>
